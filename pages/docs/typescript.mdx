...
If it's not possible to conform your theme shape to this structure, you can create your own types for System Props. [View the source of this package on GitHub to see how it provides the stock types.](https://github.com/roginfarrer/system-props)
