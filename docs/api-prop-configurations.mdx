---
title: Prop Configurations
description: Out-of-the-box prop configurations for System Props
---
...
| `transitionDuration`       | transition-duration        | transitionDurations       |
| `transitionTimingFunction` | transition-timing-function | transitionTimingFunctions |
| `transitionDelay`          | transition-delay           |                           |
| `transitionProperty`       | transition-property        |                           |

```js
<Box transition="$standard" />

<Box
  transitionProperty="color"
  transitionDuration="$rapid"
